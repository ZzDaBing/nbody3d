_report = {
  metrics = {
    ...
    nb_loops_80_if_clean = 4,
    speedup_if_fully_vectorised = 1.0013,
    ...
    number_processes = 1,
    speedup_if_FP_only = 1.0017,
    nb_threads = 1,
    application_time = 35.68,
    compilation_options = "Not Available",
    innerloops_time = 2.77,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 17.051472 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.988336 seconds.",
  },
  colors = {
