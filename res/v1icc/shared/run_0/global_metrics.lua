_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.002,
    ...
    number_processes = 1,
    speedup_if_FP_only = 1.0028,
    nb_threads = 1,
    application_time = 19.74,
    compilation_options = "Not Available",
    innerloops_time = 0.03,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.080934 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.005922 seconds.",
  },
  colors = {
