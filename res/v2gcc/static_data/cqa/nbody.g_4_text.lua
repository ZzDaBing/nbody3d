  ...
  paths = {
    {
      ...
      expert = {
        ...
        {
          title = "Back-end",
          txt = "       | P0    | P1    | P2    | P3    | P4   | P5   | P6\n-----------------------------------------------------------\nuops   | 20.50 | 20.50 | 11.50 | 11.50 | 7.00 | 7.00 | 6.00\ncycles | 20.50 | 20.50 | 11.50 | 11.50 | 7.00 | 7.00 | 6.00\n\nCycles executing div or sqrt instructions: NA\n",
        },
        {
      ...
      gain = {
        {
          ...
          txt = "Detected a slowdown caused by scalar integer instructions (typically used for address computation).\nBy removing them, you can lower the cost of an iteration from 37.00 to 30.00 cycles (1.23x speedup).",
        },
        {
