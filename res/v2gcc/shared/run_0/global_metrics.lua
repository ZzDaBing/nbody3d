_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.081,
    ...
    number_processes = 1,
    speedup_if_FP_only = 1.2679,
    nb_threads = 1,
    application_time = 23.03,
    compilation_options = "Not Available",
    innerloops_time = 99.56,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 22.993152 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 22.928668 seconds.",
  },
  colors = {
