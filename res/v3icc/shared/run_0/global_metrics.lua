_report = {
  metrics = {
    ...
    nb_loops_80_if_clean = 3,
    speedup_if_fully_vectorised = 1.0043,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0019,
    profiled_time = 13.2,
    array_access_efficiency = 95.833333333333,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.005,
    nb_threads = 1,
    application_time = 13.2,
    compilation_options = "Not Available",
    innerloops_time = 0.12,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.09504 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.01584 seconds.",
  },
  colors = {
