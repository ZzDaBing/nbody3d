_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.0774,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0004,
    profiled_time = 33.22,
    array_access_efficiency = 50.003340682836,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.2684,
    nb_threads = 1,
    application_time = 33.22,
    compilation_options = "Not Available",
    innerloops_time = 99.78,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 33.18678 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 33.146916 seconds.",
  },
  colors = {
