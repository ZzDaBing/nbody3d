_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.0041,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0015,
    profiled_time = 8.12,
    array_access_efficiency = 100,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0035,
    nb_threads = 1,
    application_time = 8.12,
    compilation_options = "Not Available",
    innerloops_time = 98.7,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 8.054228 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 8.01444 seconds.",
  },
  colors = {
