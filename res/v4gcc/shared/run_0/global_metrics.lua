_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.0283,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0022,
    profiled_time = 5.69,
    array_access_efficiency = 50.030318342597,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.1142,
    nb_threads = 1,
    application_time = 5.69,
    compilation_options = "Not Available",
    innerloops_time = 98.95,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 5.670085 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 5.630255 seconds.",
  },
  colors = {
